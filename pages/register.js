    ...
    <Box sx= {{
      ...
      <Box sx={{
        ...
        bgcolor:"#FFFFFF",
          ...
          <Box sx={{ml:4, color:"#A442F1" , display:"flex", mr:4, fontWeight:"bold" , fontSize:"16px  "}}>
           <AiOutlineArrowLeft />
          <Box sx={{ ml:1}}>
            Atras
          </Box>
      ...
      <Grid sx={{pb:2}}>
        <Grid container spacing={1} sx={{pb:2}}> 
          ...
          <Box sx={{bgcolor:"#f5f5f5f5" , pt:2}} >
           ...
           <Grid  sm={10} sx={{ pt:2, display:"flex", width: "516px", height:" 104px"}} item>
          ...
          <Box>
              ...
              <Grid xs={12} item>
                <Grid sx={{color: "#A442F1", fontWeight:"bold", textAlign:"center", p:2}}>
                 ¿olvidaste tu contraseña?
                </Grid>
              <Box>
            <Button 
            type="submit"
            sx={{color: "white", bgcolor: "#A442F1",padding: "12px 24px" , "&:hover": { color: "#A442F1"} }} fullWidth > Registrarme </Button>
        </Box>
        <Box sx={{p:3}}>
          <Divider/>
        </Box>
        <Link href="/">
        <Box>
            <Button sx={{color: "#A442F1", bgcolor: "rgba(164, 66, 241, 0.1)", padding: "12px 24px" }} fullWidth > Ya tenes cuenta? Iniciar sesión </Button>
        </Box>
        </Link>
